    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          desc:  'A comprehensive data management suite featuring advanced filtering, reporting, and user roles.',
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          desc:  'Suite de gestión de datos con filtros avanzados, reportes y roles de usuario.',
          label: 'Ver Dashboard',
        },
      ],
    },
